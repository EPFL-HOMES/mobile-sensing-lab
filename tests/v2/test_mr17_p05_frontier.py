...
def test_p05_analysis_reuses_saved_sample_utilities_and_api_reports_saved_metric(tmp_path):
    from tests.v2.test_m08a_portfolio_sampling import _two_vehicle_exposure, _portfolio_config
    from tests.v2.test_m08b_portfolio_analysis import _sample_reference
